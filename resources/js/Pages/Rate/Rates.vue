          ...
          <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group py-1">
                                <button class="btn btn-danger add-btn btn-block my-4" type="submit">Save Rate</button>
                            </div>
                          </div>
                        </div>
                      </form>           
            ...
            <div class="col-lg-8 ">
              <div class="chart_info">
                <div class="chart_info_header">
                  <h3>Today's Rate chart</h3>
                </div>
                <div class="chart_info_body">
